...
<jsp:include page="kj/head.jsp" />
 <script type="text/javascript">
      	var list_url = "${basePath}catagroy/catagroy_get3.action";
    	//搜索
      	function doSearch(){
      		//重置页号
      		$("#pageNo").val(1);
  ...
  <!--内容详细-->
   ...
   <div class="content_style">
    <div class="Products_area_style">
     ...
     <form action="${basePath }catagroy/catagroy_add3.action" method="post">
      <input name="catagroy3.name" type="text"  placeholder="分类名称" class="add_text"/>
       <input name="dengji" type="hidden"  value="3" />
          <input name="catagroy.caid" type="hidden"  value="${catagroy.caid }" />
             <input name="catagroy2.c2id" type="hidden"  value="${catagroy2.c2id }" />
      ...
      <table>
       <thead>
        <tr class="title">
         ...
         <td class="title_name">三级分类id</td>
         <td class="inventory">三级分类名称</td>
         <td class="status">商品数</td>
         <td class="operating">操作</td>
         </tr>
        </thead>
       <tbody>
       
       <c:forEach items="${c3set}" var="g" >
        ...
        <tr>
          ...
          <a href="#" class="fzxx_btn">复制信息</a><a href="商品专区-评价管理.html" class="pjgl_btn">评价管理</a><a href="#" class="szkc_btn">设置库存</a><a href="${basePath }catagroy/catagroy_delete3.action?catagroy3.c3id=${g.c3id}" class="sj_btn">删除</a></td>
        </tr>
       </c:forEach>
